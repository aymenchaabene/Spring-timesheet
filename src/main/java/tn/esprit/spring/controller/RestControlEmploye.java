...
public class RestControlEmploye {
	...
	@PostMapping(path = "/ajouterEmploye",
			consumes = "application/json", produces = "application/json"
			)
	@ResponseBody
	public String ajouterEmploye(@PathVariable  Employe  employe ) {
		iemployeservice.ajouterEmploye(employe);
		return employe.toString();
	}


	@PutMapping(value = "/modifyEmail/{id}/{newemail}",produces = org.springframework.http.MediaType.APPLICATION_JSON_VALUE)
	@ResponseBody
	...
	@ResponseBody
	public int ajouterContrat(@PathVariable Contrat contrat) {
